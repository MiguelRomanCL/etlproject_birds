"""
PREDICTOR DE GANANCIA - PRODUCCIÓN 01
Sistema de predicción basado en Modelo02 (Versión Limpia)
...
class PredictorGanancia:
    """
    Predictor de ganancia promedio de pollos usando Modelo02
    """
    
    def __init__(self, modelo_path='../../analisis/modelo02/modelo_limpio_final'):
        """
    ...
    def predecir_lote(self, archivo_csv, guardar_resultado=True):
        ...
        if guardar_resultado:
            archivo_salida = archivo_csv.replace('.csv', '_predicciones.csv')
...
def ejemplo_comparacion_escenarios():
    ...
    escenarios = [
        ...
        },
        {
            ...
            'mes_carga': 6,
            'sexo': 'MACHO',
            'kilos_recibidos_percapita': 3.5,  # Más alimento
            'tipoConstruccion': 'Black Out',    # Mejor infraestructura
            'densidad_pollos_m2': 14.0          # Menor densidad
        },
        {
...
if __name__ == "__main__":
    ...
    print("\n" + "🚀 "*35)
    print("SISTEMA DE PREDICCIÓN - MODELO 02 (VERSIÓN LIMPIA)")
    print("🚀 "*35)
