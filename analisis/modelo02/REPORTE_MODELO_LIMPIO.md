...
| Feature | VIF | Status |
|---------|-----|--------|
| kilos_recibidos_percapita | 15.81 | 🔴 Alto |
| densidad_pollos_m2 | 13.28 | 🔴 Alto |
| mes_carga | 4.14 | ✅ Excelente |
...
|----------|---------------|---------------|
| mes_carga | 4.28 | 4.14 |
| kilos_recibidos_percapita | 91.28 | 15.81 |
| densidad_pollos_m2 | 17.33 | 13.28 |
...
|---------|-------------------|-------------------|------------|
| **MAE** | 1.5307 | 1.5407 | +0.0100 |
| **R²** | 0.9022 | 0.8956 | -0.0066 |

**Cambio porcentual en MAE:** +0.65%
