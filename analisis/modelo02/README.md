...
### Opción 1: Un Click
```
1. Navegar a: C:\tecnoandina\f35_modelacion2\analisis\modelo02\
...
```bash
cd C:\tecnoandina\f35_modelacion2\analisis\modelo02
...
```python
%run C:\tecnoandina\f35_modelacion2\analisis\modelo02\analisis_modelamiento_limpio.py
```
